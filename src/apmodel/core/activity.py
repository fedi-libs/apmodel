...
class Activity(Object):
    ...
    actor: Optional[Union[str, Actor, List[Union[str, Actor]]]] = msgspec.field(
        default=None
    )
    object: Optional[Union[str, Dict[str, Any], Object]] = msgspec.field(default=None)
    target: Optional[Union[str, Actor, List[Union[str, Actor]]]] = msgspec.field(
        default=None
    )
    ...
    @classmethod
    def model_validate(
        cls: type[Activity], data: Any, context: Optional[Dict[str, Any]] = None
    ) -> Activity:
