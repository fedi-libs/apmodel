...
class Collection(Object):
    ...
    current: Optional[Union[str, CollectionPage, OrderedCollectionPage, Link]] = (
        msgspec.field(default=None)
    )
    first: Optional[Union[str, CollectionPage, OrderedCollectionPage, Link]] = (
        msgspec.field(default=None)
    )
    last: Optional[Union[str, CollectionPage, OrderedCollectionPage, Link]] = (
        msgspec.field(default=None)
    )
    items: Optional[List[Union[Object, Link, Dict[str, Any]]]] = msgspec.field(
        default=None
    )

    @classmethod
    def model_validate(
        cls: type[Collection], data: Any, context: Optional[Dict[str, Any]] = None
    ) -> Collection:
...
class CollectionPage(Collection):
    ...
    @classmethod
    def model_validate(
        cls: type[CollectionPage], data: Any, context: Optional[Dict[str, Any]] = None
    ) -> CollectionPage:
        if not isinstance(data, dict):
            if isinstance(data, cls):
                return data
...
class OrderedCollection(Collection):
    ...
    ordered_items: Optional[List[Union[Object, Link, Dict[str, Any], str]]] = (
        msgspec.field(default=None)
    )

    @classmethod
    def model_validate(
        cls: type[OrderedCollection],
        data: Any,
...
class OrderedCollectionPage(OrderedCollection, CollectionPage):
    ...
    @classmethod
    def model_validate(
        cls: type[OrderedCollectionPage],
        data: Any,
        context: Optional[Dict[str, Any]] = None,
